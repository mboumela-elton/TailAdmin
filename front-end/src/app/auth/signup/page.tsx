...
const SignUp: React.FC = () => {
  ...
  const handleUsernameChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    setSubmitValid(true);
    username.length > 0 ? setUsernameValid(true) : setUsernameValid(false);
  };
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    if (password === "" || validateEmail(password) === true) {
    ...
    if (
      ...
      axios
        .post(`${ipAdress}/public/signup`, { username, email, password })
        .then((response) => {
  ...
  return (
    <DefaultLayout>
      ...
      <Breadcrumb page1="Authentification" page2="Sign Up" />
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={
                        isUsernameValid ? borderDefautStyle : borderError
                      }
                    />
                    {!isUsernameValid && (
