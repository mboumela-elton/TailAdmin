"use client";
import React, { useState, useRef, ChangeEvent, FormEventHandler } from "react";
...
const SignIn: React.FC = () => {
  ...
  const linkRefAdmn = useRef<HTMLAnchorElement | null>(null);
  ...
  const handleClickLink = () => {
    ...
    if (linkRef.current && role === "USER") {
      linkRef.current.click();
    }

    if (linkRefAdmn.current && role === "ADMIN") {
      linkRefAdmn.current.click();
    }
  };
  ...
  const handlePasswordChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    setPassword(pass);
    setSubmitValid(true);
    setPasswordValid(validatePassword(pass));
  };
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    if (
      ...
      axios
        .post(`${ipAdress}/public/login`, { email, password })
        .then((response) => {
        ...
        .catch((error) => {
          ...
          if (err && err.includes("email entered")) {
            setErrorMsg(err);
            setEmailValid(false);
          } else if (err && err.includes("password")) {
            setErrorMsg(err);
            setPasswordValid(false);
          } else {
  ...
  const borderError =
    "w-full rounded-lg border border-danger bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-red focus-visible:shadow-none dark:border-danger dark:bg-form-input dark:text-white dark:focus:border-red";
  return (
    <DefaultLayout>
      <Link ref={linkRef} href="/forms/form-layout"></Link>
      <Link ref={linkRefAdmn} href="/dashboard"></Link>
      <Breadcrumb page1="Authentification" page2="Sign In" />
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                Welcome ! Our app is designed to collect information about you
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      type="email"
                      placeholder="Enter your email. Ex: tailAdmin@gmail.com"
                      className={isEmailValid ? borderDefautStyle : borderError}
                    />
                    {!isEmailValid && (
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      type="password"
                      placeholder="6+ Character, One Capital letter"
                      className={
                        isPasswordValid ? borderDefautStyle : borderError
                      }
                    />
                    {!isPasswordValid && (
                      <span className="mt-1 text-sm text-red">
                ...
                <div className="mb-5">
                  ...
                  {errorMsg && (
                    <div className="flex justify-center gap-20">
                      <span className="mt-1 text-sm text-red">{errorMsg}</span>
                    </div>
                  )}
                </div>
